  								...
  								<div style="width: 400px; border-radius: 5px;" class="modal-card">
									...
									<section style="display: inline-grid; text-align: center;"class="modal-card-body">
										...
										<p>
											...
											<a style="margin-left: 5px; margin-right: 5px;" href=https://github.com/HeyEbb><img style="height: 20px; max-width: 100%;" src=/images/gh.png alt="Link to Sicarius Twitter Page"></a>
										</p>
